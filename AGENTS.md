...
# Run data simulator (generates events to Kafka)
...
- **Imports order**:
  ...
  3. Local imports (e.g., from other modules in this project)
...
- **Constants**: UPPER_CASE at module level (e.g., `SERVERS`, `RANKS`)
...
```
/Users/zyq/my-projects/game-analytics/
├── game_analytics/       # Main Flask package
│   ├── app.py           # Flask app factory
│   ├── config.py        # Configuration
│   ├── models/          # Data models
│   ├── repositories/    # ClickHouse data access
...
└── requirements.txt     # Additional Python deps (kafka-python-ng)
```
